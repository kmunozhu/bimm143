...
The 1st PC captures 44.27% of the original variance. 72.6% is captured
in the first 3 PCs
...
To get our cluster out of this tree we need to CUT it with the
‘cutree()’ function.
...
We can use the ‘table()’ function to comapre the $diagnosis vector with
...
befor and new cancer cell data and project that data onto our PCA space
